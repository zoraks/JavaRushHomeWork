...
public class Solution {
    public static void main(String[] args) {
        ...
        Hen hen1 = HenFactory.getHen(Country.GERMAN);
        System.out.println(hen1.getDescription());
        Hen hen2 = HenFactory.getHen(Country.USA);
        System.out.println(hen2.getDescription());
        Hen hen3 = HenFactory.getHen(Country.ITALIAN);
    ...
    static class HenFactory{
        static Hen getHen(String country){
            ...
            if (country.equals(Country.GERMAN)) hen = new GermanHen();
            if (country.equals(Country.USA)) hen = new AmericanHen();
            if (country.equals(Country.ITALIAN)) hen = new ItalianHen();
            return hen;
        }
    }
}
